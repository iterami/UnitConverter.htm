...
function calculate(group){
    ...
    const input = core_elements[group + '_input'].value;
    const output = core_elements[group + '_output'].value;
    let value = core_elements[group + '_value'].value;
...
function repo_init(){
      ...
      'globals': {
        'units': {
          ...
          'Density': {
            ...
            'metric tons per cubic metre [t/m³]': 1e6,
          ...
          'Fuel': {
            ...
            'litres per 100 kilometres [l/100km]': 1e5,
          ...
          'Power': {
            ...
            'Btu per hour [Btu/h]': 3.412142,
            'donkeypower': .004,
            'electric horsepower [hpE]': 1 / 746,
            'imperial horsepower [hp]': 1 / 745.7,
          ...
          'Radioactivity<br>Dose Equivalent': {
            '_default': 'sievert [Sv]',
            'banana equivalent dose [BED]': 1e7,
            'sievert [Sv]': 1,
          ...
          'Temperature': {
            ...
            'Dalencé': void 0,
            'Daniell': void 0,
            'degree of frost [Celsius]': void 0,
            'degree of frost [Fahrenheit]': void 0,
            'De la Hire': void 0,
            'De la Ville': void 0,
            'Delisle [°D]': void 0,
            'De Luc': void 0,
          ...
          'Volume': {
            ...
            'to [斗]': 1331 / 24010,
            'tun': 1 / 981.95544,
            'twenty-foot equivalent unit [TEU]': 1 / 28.316846592 / 1360,
            'urna': 1 / 13.08,
            'velt': 1 / 227.11 * 30,
    ...
    for(const type in units){
        core_elements[type + '_input'] = document.getElementById(type + '_input');
        ...
        core_elements[type + '_input'].onchange
          = core_elements[type + '_input_power'].oninput
          = core_elements[type + '_output'].onchange
          = core_elements[type + '_output_power'].oninput
          = core_elements[type + '_value'].oninput = function(){
            calculate(this.id);
        };

        core_elements[type + '_output'].value = units[type]._default;
...
function reverse(id){
    [core_elements[id + '_input'].value, core_elements[id + '_output'].value]
      = [core_elements[id + '_output'].value, core_elements[id + '_input'].value];
    [core_elements[id + '_input_power'].value, core_elements[id + '_output_power'].value]
      = [core_elements[id + '_output_power'].value, core_elements[id + '_input_power'].value];

    calculate(id);
    core_elements[id + '_value'].focus();
}
...
function temperature_formulae(value){
    return {
      ...
      'Celsius [°C]': {
        ...
        'degree of frost [Celsius]': -value,
        'degree of frost [Fahrenheit]': -value * 1.8 + 32,
      ...
      'degree of frost [Celsius]': -value,
      'degree of frost [Fahrenheit]': -value / 1.8,
